      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {!isQuizMode ? (
                  ...
                  <Button 
                    ...
                    className={cn(
                        ...
                        lessons[activeLessonIndex].completed 
                            ...
                            : "bg-red-900 hover:bg-red-800" // CORRIGIDO AQUI
                    )}
                  >
            ...
            // MODO QUIZ
            <Card className="border-t-4 border-t-red-900 animate-in zoom-in duration-300"> {/* CORRIGIDO AQUI */}
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                   <FileText className="h-5 w-5 text-red-900" /> {/* CORRIGIDO AQUI */}
                ...
                {quizScore === null ? (
                   ...
                   <div className="text-center py-8 space-y-6">
                      ...
                      <div className="flex justify-center gap-4 pt-2">
                        ...
                        <Button className="bg-red-900 hover:bg-red-800 text-white shadow-md"> {/* CORRIGIDO AQUI */}
              ...
              {quizScore === null && (
                 <CardFooter className="bg-gray-50 flex justify-end p-6">
                    <Button type="submit" form="quiz-form" size="lg" className="bg-red-900 hover:bg-red-800 text-white w-full sm:w-auto"> {/* CORRIGIDO AQUI */}
                        Finalizar Prova
                    </Button>
                 </CardFooter>
              )}
                             ...
                             <button
                                ...
                                className={cn(
                                   ...
                                   activeLessonIndex === index && !isQuizMode 
                                     ? "bg-red-50 border-l-red-900" // CORRIGIDO AQUI
                             ...
                             >
                                <div className="shrink-0">
                                   {lesson.completed ? (
                                      ...
                                      <PlayCircle className={cn(
                                        "h-5 w-5",
                                        activeLessonIndex === index ? "text-red-900" : "text-gray-400" // CORRIGIDO AQUI
                                      )} />
                                   )}
                                </div>
                                <div className="flex-1 min-w-0">
                                   <p className={cn(
                                     ...
                                     activeLessonIndex === index && !isQuizMode ? "text-red-900" : "text-gray-700" // CORRIGIDO AQUI
                                   )}>
